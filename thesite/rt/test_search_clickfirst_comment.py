...
class MySeleniumTests(LiveServerTestCase):
    ...
    def test_search_clickfirst_comment(self):
        ...
        time.sleep(1)
        self.selenium.find_element_by_xpath('/html/body/div[8]/div/div[2]/div/div[2]/a').click() #  LoadMore
        time.sleep(2)
        self.selenium.find_element_by_xpath(
        ...
        time.sleep(1)
        self.selenium.find_element_by_xpath(
            '/html/body/div[8]/div/div/button').click()  # comment
        time.sleep(0.2)
        self.selenium.find_element_by_xpath(
        ...
        self.selenium.find_element_by_xpath('//*[@id="inlineRadio5"]').click()
