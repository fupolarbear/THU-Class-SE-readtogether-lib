...
class Book(models.Model):
    ...
    name_cn = models.CharField(max_length=200, default=None)
    author = models.CharField(max_length=300)
    press = models.CharField(max_length=200)
    pub_year = models.SmallIntegerField(default=None)
    revision = models.SmallIntegerField(default=0)
    ISBN = models.CharField(max_length=50)
    name_origin = models.CharField(max_length=200, default=None)
    translator = models.CharField(max_length=200, default=None)
    pub_year_origin = models.SmallIntegerField(default=None)
