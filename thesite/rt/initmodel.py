...
comment = Permission.objects.create(codename='can_comment', \
    name='can comment', content_type=dummy_type)
manage = Permission.objects.create(codename='can_manage', name='can manage', content_type=dummy_type)
search = Permission.objects.create(codename='can_search', name='can search', content_type=dummy_type)
